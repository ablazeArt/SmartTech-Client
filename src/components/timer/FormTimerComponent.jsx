...
import FormTimerCheckbox from "./FormTimerCheckBox";

const FormTimerComponent = () => {
  ...
  const actuatorDisplayBlock = new CheckBoxDisplay("timerActuator", "timer-actuator-checkbox", "timer-actuator-display");
...
export default FormTimerComponent;
