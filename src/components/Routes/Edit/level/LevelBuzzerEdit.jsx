...
const LevelBuzzerEdit = () => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API}/commandLevelBuzzer/${commandId}`)
      .then((response) => {
        //แยกข้อมูล
  ...
  const submitForm = (e) => {
    e.preventDefault();
    axios
      .put(`${process.env.REACT_APP_API}/commandLevelBuzzer/${commandId}`, {
        actuatorName,
        levelValue,
        status,
        condition,
...
export default LevelBuzzerEdit;
