...
const LevelSolenoidEdit = () => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API}/commandLevelSolenoid/${commandId}`)
      .then((response) => {
        //แยกข้อมูล
            ...
            <form onSubmit={submitForm}>
              <div className="row align-items-start">
                <div className="col column-line command-actuator">
                  <h1 className="actuator-name-form">Level</h1>
                </div>
                <div className="col column-line command-actuator">
                  <h1>
  ...
  const submitForm = (e) => {
    e.preventDefault();
    axios
      .put(`${process.env.REACT_APP_API}/commandLevelSolenoid/${commandId}`, {
        actuatorName,
        levelValue,
        status,
        condition,
...
export default LevelSolenoidEdit;
