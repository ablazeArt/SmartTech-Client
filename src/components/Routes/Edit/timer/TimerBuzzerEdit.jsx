...
const TimerBuzzerEdit = () => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API}/commandTimerBuzzer/${commandId}`)
      .then((response) => {
        //แยกข้อมูล
  ...
  const submitForm = (e) => {
    e.preventDefault();
    axios
      .put(`${process.env.REACT_APP_API}/commandTimerBuzzer/${commandId}`, {
        actuatorName,
        dayStart,
        hourStart,
        minuteStart,
...
export default TimerBuzzerEdit;
