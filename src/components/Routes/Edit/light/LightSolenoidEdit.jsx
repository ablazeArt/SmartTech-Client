...
const LightSolenoidEdit = () => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API}/commandLightSolenoid/${commandId}`)
      .then((response) => {
        //แยกข้อมูล
  ...
  const submitForm = (e) => {
    e.preventDefault();
    axios
      .put(`${process.env.REACT_APP_API}/commandLightSolenoid/${commandId}`, {
        actuatorName,
        lightValue,
        status,
        condition,
...
export default LightSolenoidEdit;
