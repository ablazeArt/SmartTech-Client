...
const IrsensorBuzzerEdit = () => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API}/commandIrsensorBuzzer/${commandId}`)
      .then((response) => {
        //แยกข้อมูล
  ...
  const submitForm = (e) => {
    e.preventDefault();
    axios
      .put(`${process.env.REACT_APP_API}/commandIrsensorBuzzer/${commandId}`, {
        actuatorName,
        irsensorValue,
        status,
        condition,
...
export default IrsensorBuzzerEdit;
