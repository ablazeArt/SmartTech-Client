...
const IrsensorLedEdit = () => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API}/commandIrsensorLed/${commandId}`)
      .then((response) => {
        //แยกข้อมูล
  ...
  const submitForm = (e) => {
    e.preventDefault();
    axios
      .put(`${process.env.REACT_APP_API}/commandIrsensorLed/${commandId}`, {
        actuatorName,
        irsensorValue,
        status,
        condition,
...
export default IrsensorLedEdit;
