...
const HumidityBuzzerEdit = () => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API}/commandHumidityBuzzer/${commandId}`)
      .then((response) => {
        //แยกข้อมูล
  ...
  const submitForm = (e) => {
    e.preventDefault();
    axios
      .put(`${process.env.REACT_APP_API}/commandHumidityBuzzer/${commandId}`, {
        actuatorName,
        humidityValue,
        status,
        condition
...
export default HumidityBuzzerEdit;
