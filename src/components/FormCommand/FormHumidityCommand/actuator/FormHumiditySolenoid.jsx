...
const FormHumiditySolenoid = () => {
  ...
  const submitForm = (e) => {
    e.preventDefault();
    axios
      .post(`${process.env.REACT_APP_API}/createHumiditySolenoid`, { actuatorName, humidityValue, status, condition, commandId })
      .then((response) => {
  ...
  const addId = () => {
    document.getElementById("commandIdHumiditySolenoid").value = crypto.randomUUID();
  };

  return (
    <div>
      <div className="container" id="condition-humidity-actuator-display4">
          ...
          <form onSubmit={submitForm}>
            <div className="row align-items-start command-form">
              ...
              <div className="col column-line command-actuator">
                ...
                <button id="commandIdHumiditySolenoid" type="submit" value="" onMouseMove={addId} onClick={inputValue("commandId")} className="form-submit">
                  Save
                </button>
              </div>
            </div>
...
export default FormHumiditySolenoid;
