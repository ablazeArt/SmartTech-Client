...
import FormTempBuzzer from "./actuator/FormTempBuzzer";
import FormTempDc from "./actuator/FormTempDc";
import FormTempLed from "./actuator/FormTempLed";
import FormTempServo from "./actuator/FormTempServo";
import FormTempSolenoid from "./actuator/FormTempSolenoid";
import FormTempCheckbox from "./FormTempCheckbox";

const FormTempComponent = () => {
  ...
  const actuatorDisplayBlock = new CheckBoxDisplay("actuatorTempCondition", "condition-temp-actuator-checkbox", "condition-temp-actuator-display");
...
export default FormTempComponent;
