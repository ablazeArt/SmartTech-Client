...
import FormLevelBuzzer from "./actuator/FormLevelBuzzer";
import FormLevelDc from "./actuator/FormLevelDc";
import FormLevelLed from "./actuator/FormLevelLed";
import FormLevelServo from "./actuator/FormLevelServo";
import FormLevelSolenoid from "./actuator/FormLevelSolenoid";
import FormLevelCheckbox from "./FormLevelCheckbox";

const FormLevelComponent = () => {
  ...
  const actuatorDisplayBlock = new CheckBoxDisplay("actuatorLevelCondition", "condition-level-actuator-checkbox", "condition-level-actuator-display");
...
export default FormLevelComponent;
