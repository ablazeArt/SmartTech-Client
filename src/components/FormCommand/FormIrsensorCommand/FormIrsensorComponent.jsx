...
import FormIrsensorBuzzer from "./actuator/FormIrsensorBuzzer";
import FormIrsensorDc from "./actuator/FormIrsensorDc";
import FormIrsensorLed from "./actuator/FormIrsensorLed";
import FormIrsensorServo from "./actuator/FormIrsensorServo";
import FormIrsensorSolenoid from "./actuator/FormIrsensorSolenoid";
import FormIrsensorCheckbox from "./FormIrsensorCheckbox";

const FormIrsensorComponent = () => {
  ...
  const actuatorDisplayBlock = new CheckBoxDisplay("actuatorIrsensorCondition", "condition-irsensor-actuator-checkbox", "condition-irsensor-actuator-display");
  ...
  return (
    <div>
      <FormIrsensorCheckbox />
      <FormIrsensorServo />
      <FormIrsensorDc />
      <FormIrsensorLed />
      <FormIrsensorSolenoid />
      <FormIrsensorBuzzer />
    </div>
  );
};

export default FormIrsensorComponent;
